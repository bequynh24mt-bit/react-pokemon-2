...
export const SPRITE_BASE = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/showdown/";

export const POKEMON_DB = {
  starters: [
    { id: 1, name: 'Bulbasaur', type: 'Grass', maxHp: 45, atk: 49, img: `${SPRITE_BASE}1.gif`, 
      moves: [
    ...
    { id: 4, name: 'Charmander', type: 'Fire', maxHp: 39, atk: 52, img: `${SPRITE_BASE}4.gif`, 
      moves: [
    ...
    { id: 7, name: 'Squirtle', type: 'Water', maxHp: 44, atk: 48, img: `${SPRITE_BASE}7.gif`, 
      moves: [
        {name: 'Tackle', pwr: 40, type: 'Normal'},
  ...
  legendary: [
    { id: 150, name: 'Mewtwo', type: 'Psychic', maxHp: 106, atk: 110, img: `${SPRITE_BASE}150.gif`, moves: [
      {name: 'Psychic', pwr: 90, type: 'Psychic'},
      {name: 'Swift', pwr: 60, type: 'Normal'},
      {name: 'Psystrike', pwr: 100, type: 'Psychic'},
      {name: 'Shadow Ball', pwr: 80, type: 'Ghost'}
    ], isLegendary: true },
    { id: 384, name: 'Rayquaza', type: 'Dragon', maxHp: 105, atk: 150, img: `${SPRITE_BASE}384.gif`, moves: [
